...
public:
    ...
    Int_t NMissingHits() const {
        return(nmissinghits);
    }
    Int_t NPixelHits() const {
        return(npixelhits);
    }
    Int_t NPixelLayers() const {
        return(npixellayers);
    }
    Int_t NStripLayers() const {
        return(nstriplayers);
    }
    Int_t VertexNumber() const {
        return(vtx);
    }
    TVector3 ECalPoint() const {
        return(outerpoint);
    }
    TVector3 ClosestPoint() const {
        return(closestpoint);
    }
    TVector3 MomentumSpace() const {
        return(TVector3(Px(), Py(), Pz()));
    }
    Float_t dEdxHarmonic2() const {
        return(dedxharmonic2);
    }
    Double_t Dxy() const {
        return(dxy);
    }
    Double_t DxyError() const {
        return(dxyerr);
    }
    Double_t DxySig() const {
        return(dxy/dxyerr);
    }
    Double_t Dz() const {
        return(dz);
    }
    Double_t DzError() const {
        return(dzerr);
    }
    Double_t DzSig() const {
        return(dz/dzerr);
    }
};
...
public:
    ...
    Track Tracks(Int_t n) const {
        return(tracks[n]);
    }
    Int_t NumTracks() const {
        return(tracks.size());
    }
    Double_t XError() const {
        return(Sqrt(covmatrix(0,0)));
    }
    Double_t YError() const {
        return(Sqrt(covmatrix(1,1)));
    }
    Double_t ZError() const {
        return(Sqrt(covmatrix(2,2)));
    }
    TMatrixFSym CovMatrix() const {
        return(covmatrix);
    }
    Double_t CovMatrix(Int_t i, Int_t j) const {
...
public:
    ...
    const vector<string> *TriggerNames() const {
        return(triggernames);
    }
    const Analyse *MyAn() const {
        return(MA);
    }
};
...
public:
    ...
    Float_t PtError() const {
        return(pterror);
    }
    Float_t IsoR3Track() const {
        return(isolationr3track);
    }
    Float_t IsoR3TrackRel() const {
        return(isolationr3track/Pt());
    }
    Float_t IsoPFR3ChargedHadrons() const {
        return(pfisolationr3_sumchargedhadronpt);
    }
    Float_t IsoPFR3ChargedParticles() const {
        return(pfisolationr3_sumchargedparticlept);
    }
    Float_t IsoPFR3NeutralHadrons() const {
        return(pfisolationr3_sumneutralhadronet);
    }
    Float_t IsoPFR3SumPhotonEt() const {
        return(pfisolationr3_sumphotonet);
    }
    Float_t IsoPFR3SumPUPt() const {
        return(pfisolationr3_sumpupt);
    }
    Float_t IsoPFR4ChargedHadrons() const {
        return(pfisolationr4_sumchargedhadronpt);
    }
    Float_t IsoPFR4ChargedParticles() const {
        return(pfisolationr4_sumchargedparticlept);
    }
    Float_t IsoPFR4NeutralHadrons() const {
        return(pfisolationr4_sumneutralhadronet);
    }
    ...
    Int_t NumValidMuonHits() const {
        return(numvalidmuonhits);
    }
    Int_t NumMatchedStations() const {
        return(nummatchedstations);
    }
    bool IsGlobal() const {
        return((type & 1) > 0);
    }
    ...
    bool HasInnerTrack() const {
        return((type & 1<<4) > 0);
    }
    bool HasOuterTrack() const {
        return((type & 1<<5) > 0);
    }
    bool InOut() const {
        return((trackermuonquality & 1<<30) > 0);
    }
    bool OutIn() const {
        return((trackermuonquality & 1<<31) > 0);
    }
    bool IsPFMuon() const {
        return((type & 1<<6) > 0);
    }
    Double_t Dxy() const {
        return(innertrack.Dxy());
    }
    Double_t DxyError() const {
        return(innertrack.DxyError());
    }
    Double_t Dz() const {
        return(innertrack.Dz());
    }
    Double_t DzError() const {
        return(innertrack.DzError());
    }
    Float_t Chi2() const {
        return(chi2);
    }
    ...
    Float_t Chi2OverNdof() const {
        return(chi2/ndof);
    }
    Track InnerTrack() const {
        return(innertrack);
    }
    Track OuterTrack() const {
        return(outertrack);
    }
    Int_t NumStations() const;
    //Quality
    bool IsAll() const {
        return(trackermuonquality & 1 << 0);
    }
    bool IsAllGlobalMuons() const {
        return(trackermuonquality & 1 << 1);
    }
    bool IsAllStandAloneMuons() const {
        return(trackermuonquality & 1 << 2);
    }
    bool IsAllTrackerMuons() const {
        return(trackermuonquality & 1 << 3);
    }
    bool IsTrackerMuonArbitrated() const {
        return(trackermuonquality & 1 << 4);
    }
    bool IsAllArbitrated() const {
        return(trackermuonquality & 1 << 5);
    }
    bool IsGlobalMuonPromptTight() const {
        return(trackermuonquality & 1 << 6);
    }
    bool IsTMLastStationLoose() const {
        return(trackermuonquality & 1 << 7);
    }
    bool IsTMLastStationTight() const {
        return(trackermuonquality & 1 << 8);
    }
    bool IsTM2DCompatibilityLoose() const {
        return(trackermuonquality & 1 << 9);
    }
    bool IsTM2DCompatibilityTight() const {
        return(trackermuonquality & 1 << 10);
    }
    bool IsTMOneStationLoose() const {
        return(trackermuonquality & 1 << 11);
    }
    bool IsTMOneStationTight() const {
        return(trackermuonquality & 1 << 12);
    }
    bool IsTMLastStationOptimizedLowPtLoose() const {
        return(trackermuonquality & 1 << 13);
    }
    bool IsTMLastStationOptimizedLowPtTight() const {
        return(trackermuonquality & 1 << 14);
    }
    //only in > CMSSW_3_1_X
    bool IsGMTkChiCompatibility() const {
        return(trackermuonquality & 1 << 15);
    }
    bool IsGMStaChiCompatibility() const {
        return(trackermuonquality & 1 << 16);
    }
    bool IsGMTkKinkTight() const {
        return(trackermuonquality & 1 << 17);
    }
    bool IsTMLastStationAngLoose() const {
        return(trackermuonquality & 1 << 18);
    }
    bool IsTMLastStationAngTight() const {
        return(trackermuonquality & 1 << 19);
    }
    bool IsTMOneStationAngLoose() const {
        return(trackermuonquality & 1 << 20);
    }
    bool IsTMOneStationAngTight() const {
        return(trackermuonquality & 1 << 21);
    }
    bool IsTMLastStationOptimizedBarrelLowPtLoose() const {
        return(trackermuonquality & 1 << 22);
    }
};
...
public:
    ...
    SuperCluster SCs(UInt_t n) const {
        return(supercluster[n]);
    }
    Float_t CorrectedEcalEnergy() const {
        return(correctedecalenergy);
    }
    Float_t ESuperClusterOverTrack() const {
        return(esuperclusterovertrack);
    }
    Float_t ESeedClusterOverTrack() const {
        return(eseedclusterovertrack);
    }
    Float_t DeltaEtaSuperClusterTrack() const {
        return(deltaetasuperclustertrack);
    }
    Float_t DeltaPhiSuperClusterTrack() const {
        return(deltaphisuperclustertrack);
    }
    Float_t E1x5() const {
        return(e1x5);
    }
    ...
    Float_t SigmaIPhiIPhi() const {
        return(sigmaiphiiphi);
    }
    Float_t EHcalOverECal() const {
        return(ehcaloverecaldepth1+ehcaloverecaldepth2);
    }
    Float_t EHcalOverECalDepth1() const {
        return(ehcaloverecaldepth1);
    }
    Float_t EHcalOverECalDepth2() const {
        return(ehcaloverecaldepth2);
    }
    Float_t EHcalTowerOverECal() const {
        return(ehcaltoweroverecaldepth1+ehcaltoweroverecaldepth2);
    }
    Float_t EHcalTowerOverECalDepth1() const {
        return(ehcaltoweroverecaldepth1);
    }
    Float_t EHcalTowerOverECalDepth2() const {
        return(ehcaltoweroverecaldepth2);
    }
    Float_t IsoR3Track() const {
        return(isolationr3track);
    }
    ...
    Float_t IsoR3ECal() const {
        return(isolationr3ecal);
    }
    Float_t IsoR3ECalRel() const {
        return(IsoR3ECal()/Pt());
    }
    Float_t IsoR3HCal() const {
        return(isolationr3hcal);
    }
    Float_t IsoR3HCalRel() const {
        return(IsoR3HCal()/Pt());
    }
    Float_t IsoR3Combined() const {
        return(IsoR3Track() + IsoR3ECal() + IsoR3HCal());
    }
    Float_t IsoR3CombinedRel() const {
        return(IsoR3Combined()/Pt());
    }
    Float_t IsoR4Track() const {
        return(isolationr4track);
    }
    Float_t IsoR4ECal() const {
        return(isolationr4ecal);
    }
    Float_t IsoR4HCal() const {
        return(isolationr4hcal);
    }
    Float_t IsoPFR3Charged() const {
        return(isolationpfr3charged);
    }
    Float_t IsoPFR3Photon() const {
        return(isolationpfr3photon);
    }
    Float_t IsoPFR3Neutral() const {
        return(isolationpfr3neutral);
    }
    Float_t TrackChi2() const {
        return(trackchi2);
    }
    Float_t TrackNdof() const {
        return(trackndof);
    }
    Float_t TrackChi2OverNdof() const {
        return(trackchi2/trackndof);
    }
    Int_t NHits() const {
        return(nhits);
    }
    ...
    Int_t NHitsExpected() const {
        return(nhitsexpected);
    }
    Float_t ConversionDist() const {
        return(convdist);
    }
    Float_t ConversionDCot() const {
        return(convdcot);
    }
    Float_t ConversionRadius() const {
        return(convradius);
    }
    Float_t FractionBrems() const {
        return(fbrems);
    }
    Int_t NumBrems() const {
        return(numbrems);
    }
    Int_t Charge() const {
        return(charge);
...
public:
    Vertex() : covmatrix(3) {}
    Vertex(Double_t X, Double_t Y, Double_t Z, UInt_t Info, Double_t Chi2, Double_t Ndof, Double_t Ptq, Int_t Ntracks, const Float_t *Cov);
    Double_t Chi2() const {
        return(chi2);
    }
    Double_t Ndof() const {
    ...
    bool IsGood() const {
        return(!IsFake() && ndof > 4 && Z() < 24. && Perp() < 2.);
    }
};
...
public:
    ...
    TVector3 PositionAtEcal(UInt_t n) const {
        return(ecalpoints[n]);
    }
    Float_t MVAOut() const {
        return(mvaout);
    }
...
public:
    ...
    Float_t R9() const {
        return(e3x3/SCs(0).RawEnergy());
    }
    Float_t R25() const {
        return(e5x5/SCs(0).RawEnergy());
    }
    Float_t SigmaIEtaIEta() const {
        return(sigmaietaieta);
    }
    Float_t SigmaIEtaIPhi() const {
        return(sigmaietaiphi);
    }
    Float_t SigmaIPhiIPhi() const {
        return(sigmaiphiiphi);
    }
    Float_t MaxEnergyXtal() const {
        return(maxenergyxtal);
    }
    Float_t EHCalOverECal() const {
        return(ehcaloverecaldepth1+ehcaloverecaldepth2);
    }
    ...
    Float_t IsoR3TrackHollow() const {
        return(isolationr3trackhollow);
    }
    UInt_t IsoR3NTrack() const {
        return(isolationr3ntrack);
    }
    UInt_t IsoR3NTrackHollow() const {
        return(isolationr3ntrackhollow);
    }
    Float_t IsoR3ECal() const {
        return(isolationr3ecal);
    }
    ...
    Float_t IsoR4TrackHollow() const {
        return(isolationr4trackhollow);
    }
    UInt_t IsoR4NTrack() const {
        return(isolationr4ntrack);
    }
    UInt_t IsoR4NTrackHollow() const {
        return(isolationr4ntrackhollow);
    }
    Float_t IsoR4ECal() const {
        return(isolationr4ecal);
    }
    ...
    Float_t IsoPFR4Charged() const {
        return(isolationpfr4charged);
    }
    Float_t IsoPFR4Photon() const {
        return(isolationpfr4photon);
    }
    Float_t IsoPFR4Neutral() const {
        return(isolationpfr4neutral);
    }
    Float_t IsoPFR3NoFPCharged() const {
        return(isolationpfr4noscfootprintcharged);
    }
    Float_t IsoPFR3NoFPPhoton() const {
        return(isolationpfr4noscfootprintphoton);
    }
    Float_t IsoPFR3NoFPNeutral() const {
        return(isolationpfr4noscfootprintneutral);
    }
    bool isPhoton() const {
        return((info & 1) > 0);
    }
    ...
    bool HasPromptElectron() const {
        return((info & 1<<3) > 0);
    }
    //Gap?
    bool IsEB() const {
        return((gapinfo & 1<<0) > 0);
    }
    bool IsEE() const {
        return((gapinfo & 1<<1) > 0);
    }
    bool IsEBGap() const {
        return((gapinfo & 1<<2) > 0);
    }
    bool IsEBEtaGap() const {
        return((gapinfo & 1<<3) > 0);
    }
    bool IsEBPhiGap() const {
        return((gapinfo & 1<<4) > 0);
    }
    bool IsEEGap() const {
        return((gapinfo & 1<<5) > 0);
    }
    bool IsEERingGap() const {
        return((gapinfo & 1<<6) > 0);
    }
    bool IsEEDeeGap() const {
        return((gapinfo & 1<<7) > 0);
    }
    bool IsEBEEGap() const {
        return((gapinfo & 1<<8) > 0);
    }
    //Conversions
    UInt_t NumConversions() const {
        return(conversions.size());
    }
    Conversion Conversions(UInt_t n) const {
...
public:
    ...
    Float_t HadEnergyFraction() const {
        return(hadronicenergy/E()/energycorr);
    }
    Float_t HadEnergy() const {
        return(hadronicenergy);
    }
    Float_t EMEnergyFraction() const {
        return(emenergy/E()/energycorr);
    }
    Float_t EMEnergy() const {
        return(emenergy);
    }
    Float_t ChargedHadEnergyFraction() const {
        return(chargedhadronicenergy/E()/energycorr);
    }
    Float_t ChargedHadEnergy() const {
        return(chargedhadronicenergy);
    }
    Float_t ChargedEMEnergyFraction() const {
        return(chargedemenergy/E()/energycorr);
    }
    Float_t ChargedEMEnergy() const {
        return(chargedemenergy);
    }
    Float_t HFEMEnergy() const {
        return(hfemenergy);
    }
    Float_t HFHadEnergy() const {
        return(hfhadronicenergy);
    }
    ...
    Int_t ChargedMulti() const {
        return(chargedmulti);
    }
    Int_t NeutralMulti() const {
        return(neutralmulti);
    }
    Int_t HFEMMulti() const {
        return(hfemmulti);
    }
    Int_t HFHadMulti() const {
        return(hfhadronicmulti);
    }
    Int_t ElectronMulti() const {
        return(electronmulti);
    }
    Int_t MuonMulti() const {
        return(muonmulti);
    }
    Float_t ChargedPrincipalAxisA() const {
        return(chargeda);
    }
    Float_t ChargedPrincipalAxisB() const {
        return(chargedb);
    }
    Float_t NeutralPrincipalAxisA() const {
        return(neutrala);
    }
    Float_t NeutralPrincipalAxisB() const {
        return(neutralb);
    }
    Float_t PrincipalAxisA() const {
        return(alla);
    }
    Float_t PrincipalAxisB() const {
        return(allb);
    }
    Float_t ChargedMomentumFractionFromMV() const {
        return(chargedfractionmv);
    }
    void ScaleMV(bool mvonly);
    Float_t BTag(Int_t n) const;
    Float_t JECRaw() const {
        return(energycorr);
    }
    Float_t JECUncertainty() const {
        return(energycorrunc);
    }
    Float_t JECL7UDSCorretion() const {
        return(energycorrl7uds);
    }
    Float_t JECL7BottomCorretion() const {
        return(energycorrl7bottom);
    }
    //btag
    Float_t trackCountingHighPurBJetTags() const {
        return(btag[0]);
    }
    Float_t trackCountingHighEffBJetTags() const {
        return(btag[1]);
    }
    Float_t simpleSecondaryVertexHighPurBJetTags() const {
        return(btag[2]);
    }
    Float_t simpleSecondaryVertexHighEffBJetTags() const {
        return(btag[3]);
    }
    Float_t combinedSecondaryVertexBJetTags() const {
        return(btag[4]);
    }
    Float_t combinedSecondaryVertexMVABJetTags() const {
        return(btag[5]);
    }
    Float_t puIdFull() const {
        return(puidfull);
    }
    Float_t puIdSimple() const {
        return(puidsimple);
    }
    Float_t puIdCutBased() const {
        return(puidcutbased);
    }
    Int_t MCFlavour() const {
        return(mcflavour);
    }
};
...
public:
    ...
    Float_t IsoNeutralsPt() const {
        return(isolationneutralspt);
    }
    UInt_t IsoNeutralsNum() const {
        return(isolationneutralsnum);
    }
    Float_t IsoChargedPt() const {
        return(isolationchargedpt);
    }
    UInt_t IsoChargedNum() const {
        return(isolationchargednum);
    }
    Float_t IsoGammaPt() const {
        return(isolationgammapt);
    }
    UInt_t IsoGammaNum() const {
        return(isolationgammanum);
    }
    Int_t Charge() const {
        return(charge);
    }
    Float_t EMFraction() const {
        return(emfraction);
    }
    Float_t HCalTotOverPLead() const {
        return(hcaltotoverplead);
    }
    Float_t HCal3x3OverPLead() const {
        return(hcal3x3overplead);
    }
    Float_t ECalStripSumEOverPLead() const {
        return(ecalstripsumeoverplead);
    }
    Float_t BremsRecoveryEOverPLead() const {
        return(bremsrecoveryeoverplead);
    }
    Float_t CaloComp() const {
        return(calocomp);
    }
    Float_t SegComp() const {
        return(segcomp);
    }
    ...
    Track GetTrack(UInt_t num) const {
        return(tracks[num]);
    }
    //TauDiscriminators
...
public:
    ...
    Double_t XWidth() const {
        return(xwidth);
    }
    Double_t YWidth() const {
        return(ywidth);
    }
    Double_t ZSigma() const {
        return(zsigma);
    }
};
